      ...
      <Container>
        ...
        <div className='grid grid-cols-2 md:flex justify-center gap-8 md:flex-row md:justify-between items-center mt-12'>
          <div className={styles}>
            <Image src={AvailabilityIcon} alt="" data-aos="flip-up" width={60} height={60} />
            <h3 className='text-xl font-semibold'>100% <br /> Availability</h3>
          </div>

          <div className={styles}>
            <Image src={LowestRatesIcon} alt="" data-aos="flip-up" width={60} height={60} />
            <h3 className='text-xl font-semibold'>Lowest <br /> Rates</h3>
          </div>

          <div className={styles}>
            <Image src={CustomerSupportIcon} alt="" data-aos="flip-up" width={60} height={60} />
            <h3 className='text-xl font-semibold'>24x7 <br /> Support</h3>
          </div>

          <div className={styles}>
            <Image src={DataAnalyticsIcon} alt="" data-aos="flip-up" width={60} height={60} />
